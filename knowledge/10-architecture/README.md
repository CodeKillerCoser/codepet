...
- `gateway-v1-lan-generation-contract.md`：Gateway v1 LAN 的 Host identity、QR/REST DTO、HTTPS/WSS listener 与 mDNS 运行边界；Tauri 生命周期见 `remote-access-tauri-runtime.md`。
