...
- `protocol-layers-and-device-routing.md`：当前 core/pet/provider/gateway v2 IDL、SDK 生成、多设备资源路由和 Runtime Gateway 兼容边界。
- `gateway-v2-lan-generation-contract.md`：Gateway v2 与 LAN Channel v1 的 Host identity、QR/REST DTO、HTTPS/WSS listener 与 mDNS 运行边界；Tauri 生命周期见 `remote-access-tauri-runtime.md`。
