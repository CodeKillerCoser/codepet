...
> 后续进展（2026-09-17）：[v2 统一邀请配对](../20-product/dual-route-qr-pairing.md) 已实现，并在 Windows ↔ Android 上通过不可达 LAN 邀请地址验证公网首次授权。下文保留 2026-09-10 的历史证据；本次手机无 SIM，不能替代 Mac + 4G 场景验收。
