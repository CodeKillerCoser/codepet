...
final class HandshakeResponse {
  factory HandshakeResponse({
    ...
    required RemoteHostIdentity device,
    required List<Device> devices,
  ...
  final RemoteHostIdentity device;
  final List<Device> devices;
  ...
  factory HandshakeResponse.fromJson(Object? value, {String path = 'HandshakeResponse'}) {
    ...
    return HandshakeResponse(
      ...
      device: RemoteHostIdentity.fromJson(_required(json, 'device', path), path: '$path.device'),
      devices: _decodeList<Device>(_required(json, 'devices', path), '$path.devices', (item, itemPath) => Device.fromJson(item, path: itemPath), encodeItem: (item) => item.toJson()),
...
final class RemoteHostIdentity {
  factory RemoteHostIdentity({
    required DeviceId deviceId,
    required DeviceDescriptor descriptor,
    required String identityFingerprint,
  }) {
    final validatedDeviceId = _string(deviceId, 'RemoteHostIdentity.deviceId', minLength: 1);
    final validatedDescriptor = descriptor;
    final validatedIdentityFingerprint = _string(identityFingerprint, 'RemoteHostIdentity.identityFingerprint', pattern: '^[0-9a-f]{64}\$');
    return RemoteHostIdentity._(
      deviceId: validatedDeviceId,
  ...
  factory RemoteHostIdentity.fromJson(Object? value, {String path = 'RemoteHostIdentity'}) {
    final json = _object(value, path);
  ...
  @override
  String toString() => 'RemoteHostIdentity(deviceId: $deviceId, descriptor: $descriptor, identityFingerprint: $identityFingerprint)';
}
...
final class TurnSendRequest {
  ...
  factory TurnSendRequest.fromJson(Object? value, {String path = 'TurnSendRequest'}) {
    final json = _object(value, path);
    _expectKeys(json, const {'route', 'conversation', 'clientRequestId', 'capabilityRevision', 'input', 'selection'}, path);
  ...
  @override
  String toString() => 'TurnSendRequest(route: $route, conversation: $conversation, clientRequestId: $clientRequestId, capabilityRevision: $capabilityRevision, input: $input, selection: $selection)';
}
...
final class ProtocolRequestEnvelope {
  factory ProtocolRequestEnvelope({required RequestId id, required ProtocolMethod method, required Object params, int version = protocolVersion}) {
    final checkedVersion = _integer(version, 'protocolVersion', minimum: 0, maximum: 4294967295);
    if (checkedVersion != protocolVersion) throw ProtocolCodecException('protocolVersion', 'unsupported protocol version: $checkedVersion');
    final checkedId = _string(id, 'id', minLength: 1);
    _encodeRequestParams(method, params, 'params');
    return ProtocolRequestEnvelope._(version: checkedVersion, id: checkedId, method: method, params: params);
  }

  const ProtocolRequestEnvelope._({required this.version, required this.id, required this.method, required this.params});
  ...
  factory ProtocolRequestEnvelope.fromJson(Object? value, {String path = 'ProtocolRequestEnvelope'}) {
    final json = _object(value, path);
    _expectKeys(json, const {'protocolVersion', 'id', 'method', 'params'}, path);
    final method = ProtocolMethod.fromJson(_required(json, 'method', path), path: '$path.method');
    return ProtocolRequestEnvelope(id: _string(_required(json, 'id', path), '$path.id', minLength: 1), method: method, params: _decodeRequestParams(method, _required(json, 'params', path), '$path.params'), version: _integer(_required(json, 'protocolVersion', path), '$path.protocolVersion', minimum: 0, maximum: 4294967295));
  }

  Map<String, Object?> toJson() => {'protocolVersion': version, 'id': id, 'method': method.toJson(), 'params': _encodeRequestParams(method, params, 'params')};
}
...
final class ProtocolResponseEnvelope {
  factory ProtocolResponseEnvelope({required RequestId id, required ProtocolMethod method, required ProtocolResponsePayload response, int version = protocolVersion}) {
    final checkedVersion = _integer(version, 'protocolVersion', minimum: 0, maximum: 4294967295);
    if (checkedVersion != protocolVersion) throw ProtocolCodecException('protocolVersion', 'unsupported protocol version: $checkedVersion');
    final checkedId = _string(id, 'id', minLength: 1);
    if (response is ProtocolSuccess) _encodeResponseResult(method, response.result, 'response.result');
    return ProtocolResponseEnvelope._(version: checkedVersion, id: checkedId, method: method, response: response);
  }

  const ProtocolResponseEnvelope._({required this.version, required this.id, required this.method, required this.response});
  ...
  factory ProtocolResponseEnvelope.fromJson(Object? value, {String path = 'ProtocolResponseEnvelope'}) {
    final json = _object(value, path);
    _expectKeys(json, const {'protocolVersion', 'id', 'method', 'response'}, path);
    final method = ProtocolMethod.fromJson(_required(json, 'method', path), path: '$path.method');
    final responseJson = _object(_required(json, 'response', path), '$path.response');
    final status = _string(_required(responseJson, 'status', '$path.response'), '$path.response.status');
    late final ProtocolResponsePayload response;
    if (status == 'ok') {
      _expectKeys(responseJson, const {'status', 'result'}, '$path.response');
      response = ProtocolSuccess(_decodeResponseResult(method, _required(responseJson, 'result', '$path.response'), '$path.response.result'));
    }
    else if (status == 'error') {
      _expectKeys(responseJson, const {'status', 'error'}, '$path.response');
      response = ProtocolFailure(ProtocolError.fromJson(_required(responseJson, 'error', '$path.response'), path: '$path.response.error'));
    }
    else {
      throw ProtocolCodecException('$path.response.status', 'unknown response status: $status');
    }
    return ProtocolResponseEnvelope(id: _string(_required(json, 'id', path), '$path.id', minLength: 1), method: method, response: response, version: _integer(_required(json, 'protocolVersion', path), '$path.protocolVersion', minimum: 0, maximum: 4294967295));
  }

  Map<String, Object?> toJson() {
    final responseJson = switch (response) {
      ProtocolSuccess(:final result) => <String, Object?>{'status': 'ok', 'result': _encodeResponseResult(method, result, 'response.result')},
      ProtocolFailure(:final error) => <String, Object?>{'status': 'error', 'error': error.toJson()},
    };
    return {'protocolVersion': version, 'id': id, 'method': method.toJson(), 'response': responseJson};
  }
}

final class ProtocolEventEnvelope {
  factory ProtocolEventEnvelope({required EventCursor eventCursor, required ProtocolEventName event, required Object payload, int version = protocolVersion}) {
    final checkedVersion = _integer(version, 'protocolVersion', minimum: 0, maximum: 4294967295);
    if (checkedVersion != protocolVersion) throw ProtocolCodecException('protocolVersion', 'unsupported protocol version: $checkedVersion');
    final checkedCursor = _string(eventCursor, 'eventCursor', minLength: 1);
    _encodeEventPayload(event, payload, 'payload');
    return ProtocolEventEnvelope._(version: checkedVersion, eventCursor: checkedCursor, event: event, payload: payload);
  }

  const ProtocolEventEnvelope._({required this.version, required this.eventCursor, required this.event, required this.payload});
  ...
  factory ProtocolEventEnvelope.fromJson(Object? value, {String path = 'ProtocolEventEnvelope'}) {
    final json = _object(value, path);
    _expectKeys(json, const {'protocolVersion', 'eventCursor', 'event', 'payload'}, path);
    final event = ProtocolEventName.fromJson(_required(json, 'event', path), path: '$path.event');
    return ProtocolEventEnvelope(eventCursor: _string(_required(json, 'eventCursor', path), '$path.eventCursor', minLength: 1), event: event, payload: _decodeEventPayload(event, _required(json, 'payload', path), '$path.payload'), version: _integer(_required(json, 'protocolVersion', path), '$path.protocolVersion', minimum: 0, maximum: 4294967295));
  }

  Map<String, Object?> toJson() => {'protocolVersion': version, 'eventCursor': eventCursor, 'event': event.toJson(), 'payload': _encodeEventPayload(event, payload, 'payload')};
}
...
ProtocolResponseEnvelope decodeProtocolResponse(String source) => ProtocolResponseEnvelope.fromJson(jsonDecode(source));
...
final class ProtocolClient {
  ...
  Future<TResponse> _request<TResponse>(ProtocolMethod method, Object request) async {
    ...
    final response = ProtocolResponseEnvelope.fromJson(await transport.request(envelope.toJson()));
    if (response.id != id) throw ProtocolCodecException('id', 'response id does not match request id');
    if (response.method != method) throw ProtocolCodecException('method', 'response method does not match request method');
    return switch (response.response) {
      ProtocolSuccess(:final result) when result is TResponse => result as TResponse,
      ProtocolSuccess() => throw ProtocolCodecException('response.result', 'response result has the wrong generated type'),
