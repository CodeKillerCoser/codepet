...
import type { Approval, ApprovalDecision, Conversation, ConversationContentKind, ConversationCreateCapabilities, ConversationItem, ConversationReadState, Project, ProjectChangeType, ProjectRoot, ProviderAuthentication, ProviderId, ProviderUsage, TurnInput, TurnSelection, TurnSendCapabilities, TurnTask, UsageDataset, UsageQuery, UsageQueryResult } from "../../codepet-agent-sdk/src/generated";
export type * from "../../codepet-agent-sdk/src/generated";
import type { ClientId, ConnectionStatus, Cursor, DeviceDescriptor, EventCursor, NativeResourceId, PageInfo, ProtocolError, ProtocolVersion, ProviderInstanceId, RequestId, RoutedResourceId, RpcError, TimestampMs, TraceContext, VersionRange } from "../../codepet-core-sdk/src/generated";
...
export interface ProtocolRequestMap {
  ...
  "codepet.usage.query": UsageQueryRequest;
}
...
export interface ProtocolResponseMap {
  ...
  "codepet.usage.query": UsageQueryResponse;
}
