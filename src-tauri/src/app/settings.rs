...
pub use super::paths::DataSettings;
...
pub struct AgentRuntimeSettings {
    #[serde(default)]
    pub by_provider: HashMap<String, AgentRuntimePreferenceSettings>,
}

#[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct AgentRuntimePreferenceSettings {
    #[serde(default)]
...
pub fn load_app_settings() -> io::Result<AppSettings> {
    let path = super::paths::settings_file();
    if !path.exists() {
